...
3. **M2 — Descent slice:** orbit → atmosphere → sky → soil state machine with fades + chunk streaming stub ([`journey.md`](../game/journey.md) levels L5–L7 transition).
...
6. **M5 — Universe v1:** galaxy/system maps, 2+ planet types, travel, landing-site selection ([`journey.md`](../game/journey.md) levels L1–L4; L1 backdrop-only, L4 companions visual-only).
