...
| F3 | [`fps-widget-scroll`](../../plans/v0.3.5/fps-widget-scroll/) | in-progress | debug | sticky glance header (fps/frame/tier/GPU total) + wheel-scrollable GPU/CPU detail + sparkline in the fixed 400×280 widget; cull-by-non-emission (no scissor); scrollbar + hint |
