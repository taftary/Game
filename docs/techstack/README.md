...
- **Version:** 0.46.0 (2026-09-22, v0.3.3 `cosmic-vista-intro`
  done: vista intro boots the demo on the reference composition and
  dives to Chase; all eight v0.3.3 features done, branch merges to
  `main`)
