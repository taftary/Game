...
| Cosmic bloom per frame, cosmic views only, debug shell (update-2026-09-18-2328) | +1 bright + 4 blur passes at ≤½ res, 2 transient HDR images + scene depth; LDR bypass draws the same layouts direct (no post) | same | same |
